...
describe('createSeededRng', () => {
  ...
  it('emits the mulberry32 golden vector', () => {
    // Measured from this implementation and pinned as a literal. Every other
    // test here is satisfied by any pure generator; this one is what makes
    // "bit-identical on every JS engine for a given seed" a gate instead of a
    // claim — touch the algorithm or one of its constants and it fails.
